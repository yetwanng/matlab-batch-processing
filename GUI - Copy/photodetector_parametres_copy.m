...
% Last Modified by GUIDE v2.5 07-Dec-2017 10:19:29
...
detectivity_star = response_spectrum/sqrt(2*1.6E-19*str2double(off_current)/str2double(area_sensitive)*100);
